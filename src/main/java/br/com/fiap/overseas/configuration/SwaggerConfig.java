	...
	public OpenAPI springOverSeasOpenAPI() {
		return new OpenAPI()
				.info(new Info()
					...
					.description("OverSas - A melhor plataforma de carros eletricos do país")
					.version("v0.0.1")
				.license(new License()
					.name("FIAP")
				...
				.contact(new Contact()
					.name("Mayara Amorim")
					.email("moreiraamorim.business@gmail.com")).contact(new Contact().name("Diego Tenório").email("")))
